...
# даже обычному браузеру), 429 — ограничение частоты запросов, 503 и 520–530 —
# «проверка браузера» и ошибки Cloudflare между нами и сайтом.
AMBIGUOUS_CODES = {403, 418, 429, 503, *range(520, 531)}
